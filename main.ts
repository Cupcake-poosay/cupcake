...
game.showLongText("Press \"SPACE\" to cpntinute", DialogLayout.Bottom)
game.showLongText("Credit to Nam :3", DialogLayout.Bottom)
game.splash("Get 5 heath when get 200 SCORE")
